<?php
    ...
    $numeroJugada = $_GET["numeroJugada"];
?>
<!doctype html>
<html lang="es">
<head>
    ...
    <div class="max-w-lg bg-white shadow-lg rounded-lg p-8 text-center">
        <fieldset class="border-2 border-gray-300 rounded-lg p-6">
            ...
            <form action="index.php" method="POST">
                ...
                <div class='text-xl font-medium text-gray-800 mb-6'><h2>He adivinado el número en <?= $numeroJugada ?> jugadas<br>Me han sobrado 9 intentos</h2></div>                <!-- Botón para volver al inicio -->
