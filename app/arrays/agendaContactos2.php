...
function comprobarErrores(): boolean{
    $error = "";
    $error .= empty($nombre) ? "No ha introducido ningún nombre. " : "";
...
<body>
<form id="formularioContactos" action="agendaContactos2.php" method="post">
